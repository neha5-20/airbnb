...
function Banner() {
    return (
        <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[620px]"> 
            <Image className="overflow-hidden" src="https://links.papareact.com/0fm" layout="fill" objectFit="cover" />
